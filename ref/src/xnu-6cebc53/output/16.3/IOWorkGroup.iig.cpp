/* iig(DriverKit-427.100.5 Mar 12 2025 20:11:39) generated from IOWorkGroup.iig */
...
struct IOWorkGroup_Create_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_ool_descriptor_t  name__descriptor;
...
struct IOWorkGroup_Create_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t workgroup__descriptor;
...
#else /* KERNEL */
        const struct IOWorkGroup_Create_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOWorkGroup_Create_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOWorkGroup_Create_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IOWorkGroup_SetWorkGroupPort_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t port__descriptor;
...
struct IOWorkGroup_SetWorkGroupPort_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IOWorkGroup_SetWorkGroupPort_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOWorkGroup_SetWorkGroupPort_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOWorkGroup_SetWorkGroupPort_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IOWorkGroup_InvalidateKernel_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t client__descriptor;
...
struct IOWorkGroup_InvalidateKernel_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IOWorkGroup_InvalidateKernel_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOWorkGroup_InvalidateKernel_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOWorkGroup_InvalidateKernel_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
        ...
        IOWorkGroup ** workgroup)
{
    ...
    union
    {
        IOWorkGroup_Create_Msg_With_Content msg;
        struct
        {
            IOWorkGroup_Create_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOWorkGroup_Create_Msg_With_Content * msg = &buf.msg;
    struct IOWorkGroup_Create_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IOWorkGroup_SetWorkGroupPort_Msg_With_Content msg;
        struct
        {
            IOWorkGroup_SetWorkGroupPort_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOWorkGroup_SetWorkGroupPort_Msg_With_Content * msg = &buf.msg;
    struct IOWorkGroup_SetWorkGroupPort_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IOWorkGroup_InvalidateKernel_Msg_With_Content msg;
        struct
        {
            IOWorkGroup_InvalidateKernel_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOWorkGroup_InvalidateKernel_Msg_With_Content * msg = &buf.msg;
    struct IOWorkGroup_InvalidateKernel_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        Create_Handler func)
{
    ...
    IOWorkGroup_Create_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOWorkGroup_Create_Msg *         message = rpc.message;
    const IOWorkGroup_Create_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOWorkGroup_Create_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
    ...
    if (IOWorkGroup_Create_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOWorkGroup_Create_Msg_With_Content)) return (kIOReturnIPCError);
    ...
    ret = (*func)(        MESSAGE_CONTENT(name),
        userClient,
        (IOWorkGroup **)&reply->content.workgroup);

    if (kIOReturnSuccess != ret) return (ret);

    reply->content.__hdr.msgid = IOWorkGroup_Create_ID;
    ...
    reply->content.__hdr.objectRefs = IOWorkGroup_Create_Rpl_ObjRefs;
    reply->workgroup__descriptor.type = MACH_MSG_PORT_DESCRIPTOR;
        ...
        SetWorkGroupPort_Handler func)
{
    ...
    IOWorkGroup_SetWorkGroupPort_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOWorkGroup_SetWorkGroupPort_Msg *         message = rpc.message;
    const IOWorkGroup_SetWorkGroupPort_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOWorkGroup_SetWorkGroupPort_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (IOWorkGroup_SetWorkGroupPort_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOWorkGroup_SetWorkGroupPort_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IOWorkGroup_SetWorkGroupPort_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 0;
    reply->content.__hdr.objectRefs = IOWorkGroup_SetWorkGroupPort_Rpl_ObjRefs;
        ...
        InvalidateKernel_Handler func)
{
    ...
    IOWorkGroup_InvalidateKernel_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOWorkGroup_InvalidateKernel_Msg *         message = rpc.message;
    const IOWorkGroup_InvalidateKernel_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOWorkGroup_InvalidateKernel_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (2 != message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    if (IOWorkGroup_InvalidateKernel_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOWorkGroup_InvalidateKernel_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IOWorkGroup_InvalidateKernel_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 0;
    reply->content.__hdr.objectRefs = IOWorkGroup_InvalidateKernel_Rpl_ObjRefs;
