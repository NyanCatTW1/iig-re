/* iig(DriverKit-427.100.5 Mar 12 2025 20:11:39) generated from IOEventLink.iig */
...
struct IOEventLink_Create_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_ool_descriptor_t  name__descriptor;
...
struct IOEventLink_Create_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t eventLink__descriptor;
...
#else /* KERNEL */
        const struct IOEventLink_Create_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOEventLink_Create_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOEventLink_Create_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IOEventLink_SetEventlinkPort_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t port__descriptor;
...
struct IOEventLink_SetEventlinkPort_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IOEventLink_SetEventlinkPort_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOEventLink_SetEventlinkPort_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOEventLink_SetEventlinkPort_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IOEventLink_InvalidateKernel_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t client__descriptor;
...
struct IOEventLink_InvalidateKernel_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IOEventLink_InvalidateKernel_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOEventLink_InvalidateKernel_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOEventLink_InvalidateKernel_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
        ...
        IOEventLink ** eventLink)
{
    ...
    union
    {
        IOEventLink_Create_Msg_With_Content msg;
        struct
        {
            IOEventLink_Create_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOEventLink_Create_Msg_With_Content * msg = &buf.msg;
    struct IOEventLink_Create_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IOEventLink_SetEventlinkPort_Msg_With_Content msg;
        struct
        {
            IOEventLink_SetEventlinkPort_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOEventLink_SetEventlinkPort_Msg_With_Content * msg = &buf.msg;
    struct IOEventLink_SetEventlinkPort_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IOEventLink_InvalidateKernel_Msg_With_Content msg;
        struct
        {
            IOEventLink_InvalidateKernel_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOEventLink_InvalidateKernel_Msg_With_Content * msg = &buf.msg;
    struct IOEventLink_InvalidateKernel_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        Create_Handler func)
{
    ...
    IOEventLink_Create_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOEventLink_Create_Msg *         message = rpc.message;
    const IOEventLink_Create_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOEventLink_Create_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
    ...
    if (IOEventLink_Create_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOEventLink_Create_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    if (((OSObject *) MESSAGE_CONTENT(name)) != NULL && OSDynamicCast(OSString, (OSObject *) MESSAGE_CONTENT(name)) == NULL) { return kIOReturnBadArgument; } 
    userClient = OSDynamicCast(IOUserClient, (OSObject *) MESSAGE_CONTENT(userClient));
    if (!userClient && MESSAGE_CONTENT(userClient)) return (kIOReturnBadArgument);

    ret = (*func)(        MESSAGE_CONTENT(name),
        userClient,
        (IOEventLink **)&reply->content.eventLink);

    if (kIOReturnSuccess != ret) return (ret);

    reply->content.__hdr.msgid = IOEventLink_Create_ID;
    ...
    reply->content.__hdr.objectRefs = IOEventLink_Create_Rpl_ObjRefs;
    reply->eventLink__descriptor.type = MACH_MSG_PORT_DESCRIPTOR;
        ...
        SetEventlinkPort_Handler func)
{
    ...
    IOEventLink_SetEventlinkPort_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOEventLink_SetEventlinkPort_Msg *         message = rpc.message;
    const IOEventLink_SetEventlinkPort_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOEventLink_SetEventlinkPort_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (IOEventLink_SetEventlinkPort_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOEventLink_SetEventlinkPort_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IOEventLink_SetEventlinkPort_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 0;
    reply->content.__hdr.objectRefs = IOEventLink_SetEventlinkPort_Rpl_ObjRefs;
        ...
        InvalidateKernel_Handler func)
{
    ...
    IOEventLink_InvalidateKernel_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOEventLink_InvalidateKernel_Msg *         message = rpc.message;
    const IOEventLink_InvalidateKernel_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOEventLink_InvalidateKernel_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (2 != message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    if (IOEventLink_InvalidateKernel_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOEventLink_InvalidateKernel_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    client = OSDynamicCast(IOUserClient, (OSObject *) MESSAGE_CONTENT(client));
    ...
    reply->content.__hdr.msgid = IOEventLink_InvalidateKernel_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 0;
    reply->content.__hdr.objectRefs = IOEventLink_InvalidateKernel_Rpl_ObjRefs;
