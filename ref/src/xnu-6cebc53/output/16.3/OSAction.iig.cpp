/* iig(DriverKit-427.100.5 Mar 12 2025 20:11:39) generated from OSAction.iig */
...
struct OSAction_Create_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t target__descriptor;
...
struct OSAction_Create_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t action__descriptor;
...
#else /* KERNEL */
        const struct OSAction_Create_Msg_With_Content * message;
#endif /* KERNEL */
        struct OSAction_Create_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct OSAction_Create_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct OSAction_CreateWithTypeName_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t target__descriptor;
...
struct OSAction_CreateWithTypeName_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t action__descriptor;
...
#else /* KERNEL */
        const struct OSAction_CreateWithTypeName_Msg_With_Content * message;
#endif /* KERNEL */
        struct OSAction_CreateWithTypeName_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct OSAction_CreateWithTypeName_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct OSAction_Aborted_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
...
struct OSAction_Aborted_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct OSAction_Aborted_Msg_With_Content * message;
#endif /* KERNEL */
        struct OSAction_Aborted_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct OSAction_Aborted_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
        ...
        OSAction ** action)
{
    ...
    union
    {
        OSAction_Create_Msg_With_Content msg;
        struct
        {
            OSAction_Create_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct OSAction_Create_Msg_With_Content * msg = &buf.msg;
    struct OSAction_Create_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSAction ** action)
{
    ...
    union
    {
        OSAction_CreateWithTypeName_Msg_With_Content msg;
        struct
        {
            OSAction_CreateWithTypeName_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct OSAction_CreateWithTypeName_Msg_With_Content * msg = &buf.msg;
    struct OSAction_CreateWithTypeName_Rpl_With_Content * rpl = &buf.rpl.rpl;
...
OSAction::Aborted(        OSDispatchMethod supermethod)
{
    ...
    union
    {
        OSAction_Aborted_Msg_With_Content msg;
    } buf;
    struct OSAction_Aborted_Msg_With_Content * msg = &buf.msg;
        ...
        Create_Handler func)
{
    ...
    OSAction_Create_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const OSAction_Create_Msg *         message = rpc.message;
    const OSAction_Create_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const OSAction_Create_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
    ...
    if (OSAction_Create_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(OSAction_Create_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    target = OSDynamicCast(OSObject, (OSObject *) MESSAGE_CONTENT(target));
    if (!target && MESSAGE_CONTENT(target)) return (kIOReturnBadArgument);

    ret = (*func)(        target,
        MESSAGE_CONTENT(targetmsgid),
        MESSAGE_CONTENT(msgid),
        MESSAGE_CONTENT(referenceSize),
        (OSAction **)&reply->content.action);

    if (kIOReturnSuccess != ret) return (ret);

    reply->content.__hdr.msgid = OSAction_Create_ID;
    ...
    reply->content.__hdr.objectRefs = OSAction_Create_Rpl_ObjRefs;
        ...
        CreateWithTypeName_Handler func)
{
    ...
    OSAction_CreateWithTypeName_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const OSAction_CreateWithTypeName_Msg *         message = rpc.message;
    const OSAction_CreateWithTypeName_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const OSAction_CreateWithTypeName_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (OSAction_CreateWithTypeName_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(OSAction_CreateWithTypeName_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    if (((OSObject *) MESSAGE_CONTENT(typeName)) != NULL && OSDynamicCast(OSString, (OSObject *) MESSAGE_CONTENT(typeName)) == NULL) { return kIOReturnBadArgument; } 
    target = OSDynamicCast(OSObject, (OSObject *) MESSAGE_CONTENT(target));
    if (!target && MESSAGE_CONTENT(target)) return (kIOReturnBadArgument);
    ...
    ret = (*func)(        target,
        ...
        MESSAGE_CONTENT(msgid),
        MESSAGE_CONTENT(referenceSize),
        MESSAGE_CONTENT(typeName),
        (OSAction **)&reply->content.action);

    if (kIOReturnSuccess != ret) return (ret);

    reply->content.__hdr.msgid = OSAction_CreateWithTypeName_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 1;
    reply->content.__hdr.objectRefs = OSAction_CreateWithTypeName_Rpl_ObjRefs;
    reply->action__descriptor.type = MACH_MSG_PORT_DESCRIPTOR;
        ...
        Aborted_Handler func)
{
    ...
    OSAction_Aborted_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const OSAction_Aborted_Msg *         message = rpc.message;
    const OSAction_Aborted_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const OSAction_Aborted_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */

    if (1 != message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    if (OSAction_Aborted_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(OSAction_Aborted_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
