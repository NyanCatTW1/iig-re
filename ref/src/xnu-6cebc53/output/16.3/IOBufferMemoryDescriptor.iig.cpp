/* iig(DriverKit-427.100.5 Mar 12 2025 20:11:39) generated from IOBufferMemoryDescriptor.iig */
...
struct IOBufferMemoryDescriptor_Create_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
...
struct IOBufferMemoryDescriptor_Create_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t memory__descriptor;
...
#else /* KERNEL */
        const struct IOBufferMemoryDescriptor_Create_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOBufferMemoryDescriptor_Create_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOBufferMemoryDescriptor_Create_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IOBufferMemoryDescriptor_SetLength_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
...
struct IOBufferMemoryDescriptor_SetLength_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IOBufferMemoryDescriptor_SetLength_Msg_With_Content * message;
#endif /* KERNEL */
        struct IOBufferMemoryDescriptor_SetLength_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IOBufferMemoryDescriptor_SetLength_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
        ...
        IOBufferMemoryDescriptor ** memory)
{
    ...
    union
    {
        IOBufferMemoryDescriptor_Create_Msg_With_Content msg;
        struct
        {
            IOBufferMemoryDescriptor_Create_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOBufferMemoryDescriptor_Create_Msg_With_Content * msg = &buf.msg;
    struct IOBufferMemoryDescriptor_Create_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IOBufferMemoryDescriptor_SetLength_Msg_With_Content msg;
        struct
        {
            IOBufferMemoryDescriptor_SetLength_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IOBufferMemoryDescriptor_SetLength_Msg_With_Content * msg = &buf.msg;
    struct IOBufferMemoryDescriptor_SetLength_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        Create_Handler func)
{
    ...
    IOBufferMemoryDescriptor_Create_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOBufferMemoryDescriptor_Create_Msg *         message = rpc.message;
    const IOBufferMemoryDescriptor_Create_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOBufferMemoryDescriptor_Create_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
    ...
    if (IOBufferMemoryDescriptor_Create_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOBufferMemoryDescriptor_Create_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);

    ret = (*func)(        MESSAGE_CONTENT(options),
        MESSAGE_CONTENT(capacity),
        MESSAGE_CONTENT(alignment),
        (IOBufferMemoryDescriptor **)&reply->content.memory);

    if (kIOReturnSuccess != ret) return (ret);

    reply->content.__hdr.msgid = IOBufferMemoryDescriptor_Create_ID;
    ...
    reply->content.__hdr.objectRefs = IOBufferMemoryDescriptor_Create_Rpl_ObjRefs;
        ...
        SetLength_Handler func)
{
    ...
    IOBufferMemoryDescriptor_SetLength_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IOBufferMemoryDescriptor_SetLength_Msg *         message = rpc.message;
    const IOBufferMemoryDescriptor_SetLength_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IOBufferMemoryDescriptor_SetLength_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (1 != message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    if (IOBufferMemoryDescriptor_SetLength_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IOBufferMemoryDescriptor_SetLength_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IOBufferMemoryDescriptor_SetLength_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 0;
    reply->content.__hdr.objectRefs = IOBufferMemoryDescriptor_SetLength_Rpl_ObjRefs;
