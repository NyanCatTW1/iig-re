/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IODataQueueDispatchSource.iig */
        ...
        Create_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_Create_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_Create_Rpl)) return (kIOReturnIPCError);
        ...
        SetDataAvailableHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_SetDataAvailableHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_SetDataAvailableHandler_Rpl)) return (kIOReturnIPCError);
        ...
        SetDataServicedHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_SetDataServicedHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_SetDataServicedHandler_Rpl)) return (kIOReturnIPCError);
    action = OSDynamicCast(OSAction, (OSObject *) rpc.message->content.action);
    if (!action && rpc.message->content.action) return (kIOReturnBadArgument);
        ...
        CopyMemory_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_CopyMemory_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_CopyMemory_Rpl)) return (kIOReturnIPCError);
        ...
        CopyDataAvailableHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_CopyDataAvailableHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_CopyDataAvailableHandler_Rpl)) return (kIOReturnIPCError);
        ...
        CopyDataServicedHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_CopyDataServicedHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_CopyDataServicedHandler_Rpl)) return (kIOReturnIPCError);
        ...
        const OSMetaClass * targetActionClass)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_DataAvailable_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_DataAvailable_Rpl)) return (kIOReturnIPCError);
        ...
        const OSMetaClass * targetActionClass)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODataQueueDispatchSource_DataServiced_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODataQueueDispatchSource_DataServiced_Rpl)) return (kIOReturnIPCError);
    if (targetActionClass) {
        action = (OSAction *) OSMetaClassBase::safeMetaCast((OSObject *) rpc.message->content.action, targetActionClass);
    } else {
        action = OSDynamicCast(OSAction, (OSObject *) rpc.message->content.action);
