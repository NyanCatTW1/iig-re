/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IOServiceStateNotificationDispatchSource.iig */
        ...
        Create_Handler func)
{
    ...
    if (4 != rpc.message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceStateNotificationDispatchSource_Create_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceStateNotificationDispatchSource_Create_Rpl)) return (kIOReturnIPCError);
    if (((OSObject *) rpc.message->content.items) != NULL && OSDynamicCast(OSArray, (OSObject *) rpc.message->content.items) == NULL) { return kIOReturnBadArgument; } 
        ...
        SetHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceStateNotificationDispatchSource_SetHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceStateNotificationDispatchSource_SetHandler_Rpl)) return (kIOReturnIPCError);
        ...
        StateNotificationBegin_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceStateNotificationDispatchSource_StateNotificationBegin_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceStateNotificationDispatchSource_StateNotificationBegin_Rpl)) return (kIOReturnIPCError);
        ...
        const OSMetaClass * targetActionClass)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceStateNotificationDispatchSource_StateNotificationReady_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceStateNotificationDispatchSource_StateNotificationReady_Rpl)) return (kIOReturnIPCError);
