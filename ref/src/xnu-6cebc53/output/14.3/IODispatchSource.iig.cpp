/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IODispatchSource.iig */
        ...
        Cancel_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODispatchSource_Cancel_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODispatchSource_Cancel_Rpl)) return (kIOReturnIPCError);
        ...
        SetEnableWithCompletion_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODispatchSource_SetEnableWithCompletion_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODispatchSource_SetEnableWithCompletion_Rpl)) return (kIOReturnIPCError);
        ...
        CheckForWork_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODispatchSource_CheckForWork_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODispatchSource_CheckForWork_Rpl)) return (kIOReturnIPCError);
        ...
        SetEnable_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODispatchSource_SetEnable_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODispatchSource_SetEnable_Rpl)) return (kIOReturnIPCError);
