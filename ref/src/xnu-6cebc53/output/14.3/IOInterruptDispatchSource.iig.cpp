/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IOInterruptDispatchSource.iig */
        ...
        Create_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOInterruptDispatchSource_Create_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOInterruptDispatchSource_Create_Rpl)) return (kIOReturnIPCError);
        ...
        GetInterruptType_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOInterruptDispatchSource_GetInterruptType_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOInterruptDispatchSource_GetInterruptType_Rpl)) return (kIOReturnIPCError);
    provider = OSDynamicCast(IOService, (OSObject *) rpc.message->content.provider);
    if (!provider && rpc.message->content.provider) return (kIOReturnBadArgument);
        ...
        SetHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOInterruptDispatchSource_SetHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOInterruptDispatchSource_SetHandler_Rpl)) return (kIOReturnIPCError);
        ...
        GetLastInterrupt_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOInterruptDispatchSource_GetLastInterrupt_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOInterruptDispatchSource_GetLastInterrupt_Rpl)) return (kIOReturnIPCError);
        ...
        const OSMetaClass * targetActionClass)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOInterruptDispatchSource_InterruptOccurred_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOInterruptDispatchSource_InterruptOccurred_Rpl)) return (kIOReturnIPCError);
