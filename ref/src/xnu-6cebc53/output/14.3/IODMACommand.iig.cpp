/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IODMACommand.iig */
        ...
        Create_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODMACommand_Create_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODMACommand_Create_Rpl)) return (kIOReturnIPCError);
        ...
        PrepareForDMA_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODMACommand_PrepareForDMA_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODMACommand_PrepareForDMA_Rpl)) return (kIOReturnIPCError);
        ...
        CompleteDMA_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODMACommand_CompleteDMA_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODMACommand_CompleteDMA_Rpl)) return (kIOReturnIPCError);
        ...
        GetPreparation_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODMACommand_GetPreparation_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODMACommand_GetPreparation_Rpl)) return (kIOReturnIPCError);
        ...
        PerformOperation_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IODMACommand_PerformOperation_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IODMACommand_PerformOperation_Rpl)) return (kIOReturnIPCError);
