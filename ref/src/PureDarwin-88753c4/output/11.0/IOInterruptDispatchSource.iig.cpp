...
IOInterruptDispatchSource::_Dispatch(IOInterruptDispatchSource * self, const IORPC rpc)
{
    ...
    switch (msg->msgid)
    {
        ...
        {
            union {
                kern_return_t (IOInterruptDispatchSource::*fIn)(IOInterruptDispatchSource_SetHandler_Args);
                IOInterruptDispatchSource::SetHandler_Handler handler;
            } map;
            map.fIn = &IOInterruptDispatchSource::SetHandler_Impl;
            ret = IOInterruptDispatchSource::SetHandler_Invoke(rpc, self, map.handler);
            break;
        }
        case IODispatchSource_SetEnableWithCompletion_ID:
        {
            union {
                kern_return_t (IOInterruptDispatchSource::*fIn)(IODispatchSource_SetEnableWithCompletion_Args);
                IODispatchSource::SetEnableWithCompletion_Handler handler;
            } map;
            map.fIn = &IOInterruptDispatchSource::SetEnableWithCompletion_Impl;
        ...
        {
            union {
                kern_return_t (IOInterruptDispatchSource::*fIn)(IODispatchSource_Cancel_Args);
                IODispatchSource::Cancel_Handler handler;
            } map;
            map.fIn = &IOInterruptDispatchSource::Cancel_Impl;
        ...
        {
            union {
                kern_return_t (IOInterruptDispatchSource::*fIn)(IODispatchSource_CheckForWork_Args);
                IODispatchSource::CheckForWork_Handler handler;
            } map;
            map.fIn = &IOInterruptDispatchSource::CheckForWork_Impl;
        ...
        {
            union {
                void (IOInterruptDispatchSource::*fIn)(IOInterruptDispatchSource_InterruptOccurred_Args);
                IOInterruptDispatchSource::InterruptOccurred_Handler handler;
            } map;
            map.fIn = &IOInterruptDispatchSource::InterruptOccurred_Impl;
            ret = IOInterruptDispatchSource::InterruptOccurred_Invoke(rpc, self, map.handler);
            break;
        }
        ...
        Create_Handler func)
{
...

    {
        ...
        else
        {
            ...
            rpc.reply->source__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->source__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->source__descriptor.name        = MACH_PORT_NULL;
