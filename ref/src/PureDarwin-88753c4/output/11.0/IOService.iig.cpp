...
IOService::_Dispatch(IOService * self, const IORPC rpc)
{
    ...
    switch (msg->msgid)
    {
        ...
        {
            union {
                kern_return_t (IOService::*fIn)(IOService_ClientCrashed_Args);
                IOService::ClientCrashed_Handler handler;
            } map;
            map.fIn = &IOService::ClientCrashed_Impl;
            ret = IOService::ClientCrashed_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
        ...
        {
            union {
                kern_return_t (IOService::*fIn)(IOService_RequireMaxBusStall_Args);
                IOService::RequireMaxBusStall_Handler handler;
            } map;
            map.fIn = &IOService::RequireMaxBusStall_Impl;
            ret = IOService::RequireMaxBusStall_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
        ...
        {
            union {
                void (IOService::*fIn)(IOService_Stop_async_Args);
                IOService::Stop_async_Handler handler;
            } map;
            map.fIn = &IOService::Stop_async_Impl;
            ret = IOService::Stop_async_Invoke(rpc, self, map.handler);
            break;
        }
        ...
        CopyProperties_Handler func)
{
...

    {
        ...
        else
        {
            ...
            rpc.reply->properties__descriptor.type    = MACH_MSG_OOL_DESCRIPTOR;
            rpc.reply->properties__descriptor.copy    = MACH_MSG_VIRTUAL_COPY;
            rpc.reply->properties__descriptor.address = NULL;
            rpc.reply->properties__descriptor.size    = 0;
        }
    }
    return (kIOReturnSuccess);
        ...
        SearchProperty_Handler func)
{
...

    {
        ...
        else
        {
            ...
            rpc.reply->property__descriptor.type    = MACH_MSG_OOL_DESCRIPTOR;
            rpc.reply->property__descriptor.copy    = MACH_MSG_VIRTUAL_COPY;
            rpc.reply->property__descriptor.address = NULL;
            rpc.reply->property__descriptor.size    = 0;
        }
    }
    return (kIOReturnSuccess);
        ...
        NewUserClient_Handler func)
{
...

    {
        ...
        else
        {
            rpc.reply->content.__hdr.objectRefs = 0;
            rpc.reply->userClient__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->userClient__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->userClient__descriptor.name        = MACH_PORT_NULL;
        ...
        Create_Handler func)
{
...

    {
        ...
        else
        {
            rpc.reply->content.__hdr.objectRefs = 0;
            rpc.reply->result__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->result__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->result__descriptor.name        = MACH_PORT_NULL;
