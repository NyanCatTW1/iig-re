...
#pragma pack()
#define IOMemoryDescriptor_CreateWithMemoryDescriptors_Msg_ObjRefs (1)
        ...
        CreateMapping_Handler func)
{
...

    {
        ...
        else
        {
            rpc.reply->content.__hdr.objectRefs = 0;
            rpc.reply->map__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->map__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->map__descriptor.name        = MACH_PORT_NULL;
