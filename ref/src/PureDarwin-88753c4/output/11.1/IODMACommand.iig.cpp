/* iig(DriverKit-73.0.1) generated from IODMACommand.iig */
...
IODMACommand::_Dispatch(IODMACommand * self, const IORPC rpc)
{
    ...
    switch (msg->msgid)
    {
        ...
        {
            union {
                kern_return_t (IODMACommand::*fIn)(IODMACommand_PrepareForDMA_Args);
                IODMACommand::PrepareForDMA_Handler handler;
            } map;
            map.fIn = &IODMACommand::PrepareForDMA_Impl;
            ret = IODMACommand::PrepareForDMA_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
#if KERNEL
        ...
        {
            union {
                kern_return_t (IODMACommand::*fIn)(IODMACommand_CompleteDMA_Args);
                IODMACommand::CompleteDMA_Handler handler;
            } map;
            map.fIn = &IODMACommand::CompleteDMA_Impl;
            ret = IODMACommand::CompleteDMA_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
#if KERNEL
        ...
        {
            union {
                kern_return_t (IODMACommand::*fIn)(IODMACommand_GetPreparation_Args);
                IODMACommand::GetPreparation_Handler handler;
            } map;
            map.fIn = &IODMACommand::GetPreparation_Impl;
            ret = IODMACommand::GetPreparation_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
#if KERNEL
        ...
        {
            union {
                kern_return_t (IODMACommand::*fIn)(IODMACommand_PerformOperation_Args);
                IODMACommand::PerformOperation_Handler handler;
            } map;
            map.fIn = &IODMACommand::PerformOperation_Impl;
            ret = IODMACommand::PerformOperation_Invoke(rpc, self, map.handler);
            break;
        }
#endif /* !KERNEL */
        ...
        Create_Handler func)
{
...

    {
        ...
        else
        {
            ...
            rpc.reply->command__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->command__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->command__descriptor.name        = MACH_PORT_NULL;
        ...
        PrepareForDMA_Handler func)
{
...

    {
        ...
        {
            rpc.reply->content.__hdr.objectRefs = 0;
            rpc.reply->content.segmentsCount = 0;
        }
    }
    return (kIOReturnSuccess);
}
