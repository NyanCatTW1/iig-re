/* iig(DriverKit-73.0.1) generated from IOUserServer.iig */
        ...
        Create_Handler func)
{
...

    {
        ...
        else
        {
            ...
            rpc.reply->server__descriptor.type        = MACH_MSG_PORT_DESCRIPTOR;
            rpc.reply->server__descriptor.disposition = MACH_MSG_TYPE_PORT_NONE;
            rpc.reply->server__descriptor.name        = MACH_PORT_NULL;
