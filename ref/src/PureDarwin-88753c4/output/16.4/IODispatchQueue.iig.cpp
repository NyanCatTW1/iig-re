/* iig(DriverKit-427.100.5 Apr 30 2025 01:57:02) generated from IODispatchQueue.iig */
...
struct IODispatchQueue_SetPort_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
    mach_msg_port_descriptor_t port__descriptor;
...
struct IODispatchQueue_SetPort_Rpl_With_Content
{
    IORPCMessageMach           mach;
...
#else /* KERNEL */
        const struct IODispatchQueue_SetPort_Msg_With_Content * message;
#endif /* KERNEL */
        struct IODispatchQueue_SetPort_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IODispatchQueue_SetPort_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
...
struct IODispatchQueue_Create_Msg_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t __object__descriptor;
...
struct IODispatchQueue_Create_Rpl_With_Content
{
    IORPCMessageMach           mach;
    mach_msg_port_descriptor_t queue__descriptor;
...
#else /* KERNEL */
        const struct IODispatchQueue_Create_Msg_With_Content * message;
#endif /* KERNEL */
        struct IODispatchQueue_Create_Rpl_With_Content       * reply;
        uint32_t sendSize;
        uint32_t replySize;
#ifdef KERNEL
        const struct IODispatchQueue_Create_Msg_Content * kernelContent;
#endif /* KERNEL */
    };
        ...
        OSDispatchMethod supermethod)
{
    ...
    union
    {
        IODispatchQueue_SetPort_Msg_With_Content msg;
        struct
        {
            IODispatchQueue_SetPort_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IODispatchQueue_SetPort_Msg_With_Content * msg = &buf.msg;
    struct IODispatchQueue_SetPort_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        IODispatchQueue ** queue)
{
    ...
    union
    {
        IODispatchQueue_Create_Msg_With_Content msg;
        struct
        {
            IODispatchQueue_Create_Rpl_With_Content rpl;
            mach_msg_max_trailer_t trailer;
        } rpl;
    } buf;
    struct IODispatchQueue_Create_Msg_With_Content * msg = &buf.msg;
    struct IODispatchQueue_Create_Rpl_With_Content * rpl = &buf.rpl.rpl;
        ...
        SetPort_Handler func)
{
    ...
    IODispatchQueue_SetPort_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IODispatchQueue_SetPort_Msg *         message = rpc.message;
    const IODispatchQueue_SetPort_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IODispatchQueue_SetPort_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
    ...
    if (IODispatchQueue_SetPort_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IODispatchQueue_SetPort_Msg_With_Content)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IODispatchQueue_SetPort_ID;
    ...
    reply->content.__hdr.objectRefs = IODispatchQueue_SetPort_Rpl_ObjRefs;
        ...
        Create_Handler func)
{
    ...
    IODispatchQueue_Create_Rpl_With_Content * reply = rpc.reply;
#ifdef KERNEL
    const IODispatchQueue_Create_Msg *         message = rpc.message;
    const IODispatchQueue_Create_Msg_Content * messageContent = rpc.kernelContent;
#else /* KERNEL */
    const IODispatchQueue_Create_Msg_With_Content * message = rpc.message;
#endif /* KERNEL */
#if __has_builtin(__builtin_assume)
    __builtin_assume(reply != NULL);
#endif /* __has_builtin(__builtin_assume) */
    ...
    if (IODispatchQueue_Create_Msg_ObjRefs != MESSAGE_CONTENT(__hdr.objectRefs)) return (kIOReturnIPCError);
    if (rpc.sendSize < sizeof(IODispatchQueue_Create_Msg_With_Content)) return (kIOReturnIPCError);
    if (reply != NULL && rpc.replySize < sizeof(*reply)) return (kIOReturnIPCError);
    ...
    reply->content.__hdr.msgid = IODispatchQueue_Create_ID;
    reply->content.__hdr.flags = kIORPCMessageOneway;
    reply->mach.msgh.msgh_id   = kIORPCVersion190615Reply;
    reply->mach.msgh.msgh_size = sizeof(*reply);
    reply->mach.msgh_body.msgh_descriptor_count = 1;
    reply->content.__hdr.objectRefs = IODispatchQueue_Create_Rpl_ObjRefs;
