/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IOMemoryDescriptor.iig */
        ...
        _CopyState_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOMemoryDescriptor__CopyState_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOMemoryDescriptor__CopyState_Rpl)) return (kIOReturnIPCError);
        ...
        CreateMapping_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOMemoryDescriptor_CreateMapping_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOMemoryDescriptor_CreateMapping_Rpl)) return (kIOReturnIPCError);
        ...
        CreateSubMemoryDescriptor_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOMemoryDescriptor_CreateSubMemoryDescriptor_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOMemoryDescriptor_CreateSubMemoryDescriptor_Rpl)) return (kIOReturnIPCError);
        ...
        CreateWithMemoryDescriptors_Handler func)
{
    ...
    if (33 != rpc.message->mach.msgh_body.msgh_descriptor_count) return (kIOReturnIPCError);
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOMemoryDescriptor_CreateWithMemoryDescriptors_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOMemoryDescriptor_CreateWithMemoryDescriptors_Rpl)) return (kIOReturnIPCError);
#if !__LP64__
    for (unsigned int idx = 0; idx < withDescriptorsCount; idx++)
    {
        withDescriptors[idx] = (IOMemoryDescriptor *)(uintptr_t)rpc.message->content.__withDescriptors[idx];
    }
#else /* !__LP64__ */
    withDescriptors = (IOMemoryDescriptor **)(uintptr_t) &rpc.message->content.__withDescriptors[0];
#endif /* __LP64__ */
    for (unsigned int idx = 0; idx < withDescriptorsCount; idx++)
    {
