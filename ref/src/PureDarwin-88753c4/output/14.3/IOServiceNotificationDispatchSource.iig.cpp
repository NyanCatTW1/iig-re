/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IOServiceNotificationDispatchSource.iig */
        ...
        Create_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceNotificationDispatchSource_Create_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceNotificationDispatchSource_Create_Rpl)) return (kIOReturnIPCError);
    if (((OSObject *) rpc.message->content.matching) != NULL && OSDynamicCast(OSDictionary, (OSObject *) rpc.message->content.matching) == NULL) { return kIOReturnBadArgument; } 
        ...
        SetHandler_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceNotificationDispatchSource_SetHandler_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceNotificationDispatchSource_SetHandler_Rpl)) return (kIOReturnIPCError);
        ...
        const OSMetaClass * targetActionClass)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceNotificationDispatchSource_ServiceNotificationReady_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceNotificationDispatchSource_ServiceNotificationReady_Rpl)) return (kIOReturnIPCError);
        ...
        CopyNextNotification_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOServiceNotificationDispatchSource_CopyNextNotification_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOServiceNotificationDispatchSource_CopyNextNotification_Rpl)) return (kIOReturnIPCError);
