/* iig(DriverKit-256.100.5 Mar 10 2023 21:35:11) generated from IOMemoryMap.iig */
        ...
        _CopyState_Handler func)
{
    ...
    if (rpc.message != NULL && rpc.sendSize < sizeof(IOMemoryMap__CopyState_Msg)) return (kIOReturnIPCError);
    if (rpc.reply != NULL && rpc.replySize < sizeof(IOMemoryMap__CopyState_Rpl)) return (kIOReturnIPCError);
